    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose dark:prose-invert prose-emerald max-w-none">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">1. Agreement to Terms</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">2. Use License</h2>
          <p className="text-gray-600 dark:text-gray-300">
            Permission is granted to temporarily use CheckMate for personal, non-commercial transitory viewing only. 
            This is the grant of a license, not a transfer of title, and under this license you may not:
          </p>
          <ul className="list-disc pl-6 mt-3 mb-6 text-gray-600 dark:text-gray-300">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">3. Account Responsibilities</h2>
          <p className="text-gray-600 dark:text-gray-300">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">4. Attendance Data</h2>
          <p className="text-gray-600 dark:text-gray-300">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">5. Limitations</h2>
          <p className="text-gray-600 dark:text-gray-300">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">6. Governing Law</h2>
          <p className="text-gray-600 dark:text-gray-300">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">7. Changes to Terms</h2>
          <p className="text-gray-600 dark:text-gray-300">
