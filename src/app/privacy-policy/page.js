    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose dark:prose-invert prose-emerald max-w-none">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">1. Introduction</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">2. Data We Collect</h2>
          <p className="text-gray-600 dark:text-gray-300">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">3. How We Use Your Data</h2>
          <p className="text-gray-600 dark:text-gray-300">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">4. Data Security</h2>
          <p className="text-gray-600 dark:text-gray-300">
