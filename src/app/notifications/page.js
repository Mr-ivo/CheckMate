              ...
              <div className="flex space-x-2">
                <div className="relative">
                  <select
                    ...
                    className="pl-3 pr-8 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                  >
                ...
                <button 
                  ...
                  className="px-3 py-2 border border-gray-300 rounded-lg bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-emerald-500 flex items-center"
                >
                ...
                <button 
                  ...
                  className="px-3 py-2 border border-gray-300 rounded-lg bg-white hover:bg-gray-100 text-red-500 focus:outline-none focus:ring-2 focus:ring-red-500 flex items-center"
                >
